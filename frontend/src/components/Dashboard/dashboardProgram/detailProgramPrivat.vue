            ...
            <n-gi span="3 m:2">
              <n-space vertical :size="20">
                <n-space align="center" justify="space-between">
                  <n-h1 style="margin: 0; font-size: 2.2rem; font-weight: 600;">{{ program.subject }}</n-h1>
                ...
                <div class="schedule-details">
                    <n-text>Area</n-text><n-text>: {{ schedule.area }}</n-text>
                ...
                <n-space vertical :size="4">
                    ...
                    <n-text type="primary" strong style="font-size: 1.25rem;">{{ price.range }}</n-text>
                </n-space>
...
import {
  ...
  NDataTable, NUl, NLi, NConfigProvider
} from 'naive-ui';
...
const schedule = ref({
  ...
  activeDays: ['Selasa', 'Rabu', 'Kamis', 'Sabtu'],
  area: 'Semarang',
...
const price = ref({
    ...
    range: 'Rp1.300.000 - Rp1.720.000'
});

const pricingColumns = ref([
  { title: 'Jenis', key: 'type', className: 'table-cell-strong' },
  { title: 'Biaya Program', key: 'programFee' },
  { title: 'Jumlah Siswa', key: 'studentCount' },
  { title: 'Biaya/anak', key: 'feePerStudent' },
  { title: 'Honor Total', key: 'totalHonor', className: 'table-cell-strong' }
]);

const pricingData = ref([
  { type: 'Privat', programFee: 'Rp1.000.000', studentCount: 1, feePerStudent: 'Rp300.000', totalHonor: 'Rp910.000' },
  { type: 'Kelompok 3 Siswa', programFee: 'Rp1.000.000', studentCount: 3, feePerStudent: 'Rp240.000', totalHonor: 'Rp1.078.000' },
  { type: 'Kelompok 5 Siswa', programFee: 'Rp1.000.000', studentCount: 5, feePerStudent: 'Rp192.000', totalHonor: 'Rp1.204.000' }
]);
...
/* Global style override for table cell font weight */
:deep(.table-cell-strong .n-data-table-td) {
    font-weight: 600;
}
</style>