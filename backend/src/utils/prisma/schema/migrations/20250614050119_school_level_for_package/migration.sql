/*
  ...
  - You are about to alter the column `level` on the `bimbel_packages` table. The data in that column could be lost. The data in that column will be cast from `VarChar(191)` to `Enum(EnumId(7))`.
...
-- AlterTable
ALTER TABLE `bimbel_packages` MODIFY `level` ENUM('SD', 'SMP', 'SMA', 'Umum') NOT NULL,
