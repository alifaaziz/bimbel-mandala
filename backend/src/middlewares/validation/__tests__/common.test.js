...
const { CommonValidationMiddleware } = await import('../common.js');
...
describe('Common validation middleware', () => {
  describe('Is valid params id uuid', () => {
    ...
    it('should throw an http error if the params id is invalid', async () => {
      const { req, res, next } = setupExpressMock({
        req: {
          params: {
            id: 'invalid'
  ...
  describe('Is valid email payload', () => {
    ...
    it('should throw an http error if the email payload is invalid', async () => {
      const { req, res, next } = setupExpressMock({
        req: {
          body: {
            email: 'invalid-email'
    ...
    it('should throw an http error if the email payload is missing', async () => {
      const { req, res, next } = setupExpressMock({
        req: {
          body: {}
        }
